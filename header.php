...
<body <?php body_class(); ?> data-spy="scroll">
	<div id="page" class="site">
		...
		<!-- START NAVBAR -->
		<div class="header" <?php if ( get_header_image() ) : ?> style="width: 100%; height: 550px; background-image: url(<?php header_image(); ?>); background-size: cover; background-size: 100% 100%;"<?php endif; ?> style="background-color: #e3f2fd;">
